...
def main():
    ...
    # grid(smartgrids[0].houses, smartgrids[0].batterys)
    ...
    # grid(smartgrids[1].houses, smartgrids[1].batterys)
    ...
    # grid(smartgrids[2].houses, smartgrids[2].batterys)
    ...
    grid(smartgrids[3].houses, smartgrids[3].batterys)
    print(calculate_score(smartgrids[3].houses))
    for battery in smartgrids[3].batterys:
        print(battery)
    print("-------------------------------------")
    ...
    # random_distribution(smartgrids[4].houses, smartgrids[4].batterys, 200, 15)
    # print("-------------------------------------")
