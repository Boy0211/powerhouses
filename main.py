...
def main():
    parser = argparse.ArgumentParser(
     description="Smartgrid heuristieken: verbind huizen aan batterijen "
                 "via een smartgrid")
    ...
    parser.add_argument("probleemset",
                        choices=["statisch", "dynamisch",
                                 "batterijen_toevoegen"],
                        help="kies de probleemset: statische batterijen, "
                        "dynamische batterijen, nieuwe batterijen toevoegen")
    ...
    parser.add_argument("-a", "--additional",
                        ...
                        help="run een hillclimber op het resultaat van "
                             "greedy/k_means")
    parser.add_argument("-ppa", "--plant_propagation",
                        action="store_true",
                        default=False,
                        help="run a plant prograpation algorithm on your "
                             "hillclimber result")
    parser.add_argument("-i", "--iterations",
                        default=100,
                        type=int,
                        help="choose the amount of iterations for ppa or "
                             "random_hillclimber")
    ...
    if args.probleemset == "statisch":
        if (args.wijk == 2 or args.wijk == 3) and (
                args.greedy_type == 'greedy_capacity'):
            print("greedy_capacity kan geen resultaat geven voor wijk 2 en 3 "
                  "dat aan de constraints voldoet")
            ...
            if args.greedy_type == "greedy_distance":
                ...
                Solution1 = Solution(DataStructure.houses,
        ...
        elif args.additional == "hillclimber" and(
             args.plant_propagation is False):
            if args.greedy_type == "greedy_distance":
        ...
        if (args.additional == "hillclimber" or
            ...
            A = k_means(Solution2)
            E = hillclimber(A)
        elif args.additional == "random_hillclimber" and (
             args.plant_propagation is False):
